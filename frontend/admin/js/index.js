...
async function patient_age_group() {
  try {
    let response = await fetch(
      "https://hospital-appointment-system-s9z1.onrender.com/admin/patients/age_group",
    );
...
async function total_appointment_count() {
  try {
    let get_data = await fetch(
      "https://hospital-appointment-system-s9z1.onrender.com/admin/book_appointment/get",
    );
    ...
    let response = await fetch(
      "https://hospital-appointment-system-s9z1.onrender.com/admin/book_appointment/app_list",
    );
